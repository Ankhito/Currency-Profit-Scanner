...
public sealed class Plugin : IDalamudPlugin
{
    ...
    public Plugin()
    {
        ...
        this.scannerWindow = new ScannerWindow(this.configuration, this.scannerService, this.universalisClient, this.ipcDiagnosticsService, this.luminaDiscoveryService);
